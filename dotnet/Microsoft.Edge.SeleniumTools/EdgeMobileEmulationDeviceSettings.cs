// <copyright file="EdgeMobileEmulationDeviceSettings.cs" company="WebDriver Committers">
//
...
namespace Microsoft.Edge.SeleniumTools
{
    ...
    /// mobile device in the Edge browser.
    /// </summary>
    public class EdgeMobileEmulationDeviceSettings
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeMobileEmulationDeviceSettings"/> class.
        /// </summary>
        public EdgeMobileEmulationDeviceSettings()
        {
        }
        ...
        public EdgeMobileEmulationDeviceSettings(string userAgent)
        {
