// <copyright file="EdgePerformanceLoggingPreferences.cs" company="WebDriver Committers">
//
...
namespace Microsoft.Edge.SeleniumTools
{
    ...
    /// logging in the Edge browser.
    /// </summary>
    public class EdgePerformanceLoggingPreferences
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether Edge will collect events from the Network domain.
        ...
        /// <summary>
        /// Gets or sets a value indicating whether Edge will collect events from the Page domain.
        /// Defaults to <see langword="true"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the interval between Edge DevTools trace buffer usage events.
        ...
        /// <summary>
        /// Adds a single category to the list of Edge tracing categories for which events should be collected.
        /// </summary>
        ...
        /// <summary>
        /// Adds categories to the list of Edge tracing categories for which events should be collected.
        /// </summary>
