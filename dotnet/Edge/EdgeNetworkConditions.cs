// <copyright file="EdgeNetworkConditions.cs" company="WebDriver Committers">
//
...
namespace Microsoft.SeleniumTools.Edge
{
    ...
    public class EdgeNetworkConditions
    {
        ...
        static internal EdgeNetworkConditions FromDictionary(Dictionary<string, object> dictionary)
        {
